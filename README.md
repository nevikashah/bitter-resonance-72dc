...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-resonance-72dc
```

## Preview Deployment

A live public deployment of this template is available at [https://bitter-resonance-72dc.templates.workers.dev](https://bitter-resonance-72dc.templates.workers.dev)
